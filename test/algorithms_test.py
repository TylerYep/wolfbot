...
def test_switching_solver(caplog):
    ...
    expected_possible_roles = [
        {'Robber'},
        {'Seer', 'Hunter', 'Drunk', 'Tanner', 'Wolf', 'Insomniac', 'Mason', 'Minion', 'Villager', 'Troublemaker'},
        {'Seer'},
        {'Villager'},
        {'Mason'},
        {'Mason'},
        {'Drunk'},
        {'Seer', 'Hunter', 'Drunk', 'Tanner', 'Wolf', 'Insomniac', 'Mason', 'Minion', 'Villager', 'Troublemaker'},
        {'Seer', 'Hunter', 'Drunk', 'Tanner', 'Robber', 'Wolf', 'Insomniac', 'Mason', 'Minion', 'Villager', 'Troublemaker'},
        {'Seer', 'Hunter', 'Drunk', 'Tanner', 'Robber', 'Wolf', 'Insomniac', 'Mason', 'Minion', 'Villager', 'Troublemaker'},
        {'Seer', 'Hunter', 'Drunk', 'Tanner', 'Robber', 'Wolf', 'Insomniac', 'Mason', 'Minion', 'Villager', 'Troublemaker'},
        {'Seer', 'Hunter', 'Drunk', 'Tanner', 'Robber', 'Wolf', 'Insomniac', 'Mason', 'Minion', 'Villager', 'Troublemaker'},
        {'Seer', 'Hunter', 'Drunk', 'Tanner', 'Robber', 'Wolf', 'Insomniac', 'Mason', 'Minion', 'Villager', 'Troublemaker'},
