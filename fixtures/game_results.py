    ...
    return GameResult(
        ...
        (
            ...
            Statement(
                ...
                ((1, RoleBits(Role.SEER)), (2, RoleBits(Role.ROBBER))),
            ),
            Statement(
                "I am a Robber and I swapped with Player 1. I am now a Seer.",
                ((2, RoleBits(Role.ROBBER)), (1, RoleBits(Role.SEER))),
    ...
    return GameResult(
        ...
        (
            Statement(
                ...
                ((0, RoleBits(Role.ROBBER)), (4, RoleBits(Role.SEER)),),
    ...
    return GameResult(
        ...
        (
            Statement(
                ...
                (
                    (0, RoleBits(Role.SEER)),
                    (12, RoleBits(Role.INSOMNIAC)),
                    (14, RoleBits(Role.MINION)),
                ),
            ),
            Statement("I am a Villager.", ((1, RoleBits(Role.VILLAGER)),)),
            Statement(
            ...
            Statement(
                ...
                (
                    (3, RoleBits(Role.SEER)),
                    (13, RoleBits(Role.INSOMNIAC)),
                    (14, RoleBits(Role.HUNTER)),
                ),
            ),
            ...
            Statement(
                ...
                ((10, RoleBits(Role.DRUNK)),),
                ((SwitchPriority.DRUNK, 10, 13),),
            ),
            Statement("I am a Villager.", ((11, RoleBits(Role.VILLAGER)),)),
        ),
    )
